...
<style>
    ...
    .sidebar-trigger-btn {
        ...
        font-size: 14px;
        cursor: pointer;
        box-shadow: 0 4px 12px rgba(0, 4, 255, 0.15);
        display: flex;
        align-items: center;
        gap: 10px;
    ...
    .sidebar-trigger-btn:hover { 
        ...
        box-shadow: 0 6px 16px rgba(0, 4, 255, 0.25);
    }
...
<div class="sidebar-trigger-container">
    <button class="sidebar-trigger-btn" onclick="toggleSidebar(true)">
        <i class="fas fa-bars"></i> Open Registry Menu
    </button>
</div>
    ...
    <div class="sidebar-body">
        ...
        <div class="dropdown" id="regDropdownContainer">
            ...
            <div id="regDD" class="dropdown-content">
                <a href="{{ route('insurance.register', ['action' => 'register_client']) }}"><i class="fas fa-user-plus"></i> Client</a>
                <a href="{{ route('insurance.register', ['action' => 'register_policy']) }}"><i class="fas fa-file-alt"></i> Policy</a>
                <a href="{{ route('insurance.register', ['action' => 'register_slip']) }}"><i class="fas fa-clipboard-list"></i> Placing Slip</a>
                <a href="{{ route('insurance.register', ['action' => 'register_vehicle']) }}"><i class="fas fa-car"></i> Motor Vehicle</a>
                <a href="{{ route('insurance.register', ['action' => 'register_claim']) }}"><i class="fas fa-exclamation-triangle" style="color:#ef4444"></i> Claim</a>
            </div>
        </div>
        ...
        <div class="dropdown" id="devDropdownContainer">
            ...
            <div id="devDD" class="dropdown-content">
                <a href="{{ route('insurance.register', ['action' => 'register_potential_client']) }}"><i class="fas fa-user-plus"></i> Potential Client</a>
                <a href="{{ route('insurance.register', ['action' => 'register_quote']) }}"><i class="fas fa-file-invoice-dollar"></i> Generate Quotation</a>
        ...
        <div class="dropdown" id="insDropdownContainer">
            ...
            <div id="insDD" class="dropdown-content">
                <a href="{{ url('/insurance_broking/register?action=register_insurer') }}"><i class="fas fa-university"></i> Insurer Registry</a>
        ...
        <div class="dropdown" id="accDropdownContainer">
            ...
            <div id="accDD" class="dropdown-content">
                <a href="{{ url('/insurance_broking/accounts/smart_invoice') }}"><i class="fas fa-file-invoice"></i> Smart Invoice</a>
                <a href="{{ url('/insurance_broking/accounts/credit_note') }}"><i class="fas fa-minus-square"></i> Credit Note</a>
                <a href="{{ url('/insurance_broking/accounts/payment_voucher') }}"><i class="fas fa-file-signature"></i> Payment Voucher</a>
                <a href="{{ url('/insurance_broking/accounts/debtors') }}"><i class="fas fa-hand-holding-usd"></i> Debtors</a>
                <a href="{{ url('/insurance_broking/accounts/statements') }}"><i class="fas fa-file-invoice-dollar"></i> Statement</a>
                <a href="{{ url('/insurance_broking/accounts/receipts') }}"><i class="fas fa-receipt"></i> Payment Receipt</a>
            </div>
        </div>                  
    </div>
    ...
    <div class="sidebar-footer">
        <div class="nav-profile-group">
            <div class="nav-user-text">
                {{-- FIX: Safe authentication mapping values --}}
            ...
            <div class="dropdown" id="userDropdownContainer">
                <div class="initials-avatar" onclick="toggleDropdown('userDD', 'userDropdownContainer')">
                    {{-- FIX: Bulletproof string check initialization --}}
                    @php
